...
| Admin/control API | PRD §16 | SPEC /admin/v1 | Sprint 6 | admin auth/session + writable settings tests (PR43); remaining `/admin/v1` read models and backup/restore API pending later Sprint 6 PRs |
